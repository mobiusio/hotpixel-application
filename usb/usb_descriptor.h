...
#define CIC_PROTOCOL_CODE                AT_PCCA_101_PROTOCOL // NO_CLASS_SPECIFIC_PROTOCOL
...
#define DIC_BULK_IN_ENDP_PACKET_SIZE     (64) //(16)/* max supported is 64 */
#define DIC_BULK_OUT_ENDPOINT            (2)
#define DIC_BULK_OUT_ENDP_PACKET_SIZE    (64) // (16)/* max supported is 64*/
